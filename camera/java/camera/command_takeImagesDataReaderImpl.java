...
public class command_takeImagesDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements command_takeImagesDataReader
{
    private long copyCache;
    private command_takeImagesTypeSupport typeSupport;

    public command_takeImagesDataReaderImpl(camera.command_takeImagesTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.command_takeImagesSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.command_takeImagesHolder received_data,
    ...
    */
    ...
    synchronized public long lookup_instance(
        camera.command_takeImages instance)
    {
        long uReader = 0;
    ...
    {
        return new command_takeImagesDataReaderViewImpl(typeSupport);
    }
}
