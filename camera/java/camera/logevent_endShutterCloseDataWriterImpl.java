...
public class logevent_endShutterCloseDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements logevent_endShutterCloseDataWriter
{
    private long copyCache;
    private logevent_endShutterCloseTypeSupport typeSupport;

    public logevent_endShutterCloseDataWriterImpl(camera.logevent_endShutterCloseTypeSupport ts)
    {
        typeSupport = ts;
