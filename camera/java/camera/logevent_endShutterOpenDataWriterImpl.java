...
public class logevent_endShutterOpenDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements logevent_endShutterOpenDataWriter
{
    private long copyCache;
    private logevent_endShutterOpenTypeSupport typeSupport;

    public logevent_endShutterOpenDataWriterImpl(camera.logevent_endShutterOpenTypeSupport ts)
    {
        typeSupport = ts;
