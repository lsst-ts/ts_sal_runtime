...
public class command_takeImagesDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements command_takeImagesDataWriter
{
    private long copyCache;
    private command_takeImagesTypeSupport typeSupport;

    public command_takeImagesDataWriterImpl(camera.command_takeImagesTypeSupport ts)
    {
        typeSupport = ts;
