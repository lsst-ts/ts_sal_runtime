...
public class command_enableDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements command_enableDataReaderView
{
    ...
    public command_enableDataReaderViewImpl(camera.command_enableTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.command_enableSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.command_enableHolder received_data,
	...
	camera.command_enable instance)
    {
        long uView = 0;
