...
public class logevent_prepareToTakeImageDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements logevent_prepareToTakeImageDataWriter
{
    private long copyCache;
    private logevent_prepareToTakeImageTypeSupport typeSupport;

    public logevent_prepareToTakeImageDataWriterImpl(camera.logevent_prepareToTakeImageTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public long register_instance(
            camera.logevent_prepareToTakeImage instance_data)
    {
        long uWriter = 0;
