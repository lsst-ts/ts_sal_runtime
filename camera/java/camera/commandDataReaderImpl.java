...
public class commandDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements commandDataReader
{
    private long copyCache;
    private commandTypeSupport typeSupport;

    public commandDataReaderImpl(camera.commandTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.commandSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.commandHolder received_data,
    ...
    */
    ...
    {
        return new commandDataReaderViewImpl(typeSupport);
    }
}
