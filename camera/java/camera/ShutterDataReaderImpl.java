...
public class ShutterDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements ShutterDataReader
{
    private long copyCache;
    private ShutterTypeSupport typeSupport;

    public ShutterDataReaderImpl(camera.ShutterTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.ShutterSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.ShutterHolder received_data,
    ...
    */
    ...
    {
        return new ShutterDataReaderViewImpl(typeSupport);
    }
}
