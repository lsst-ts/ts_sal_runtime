...
public class logevent_endTakeImageDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_endTakeImageDataReaderView
{
    private long copyCache;
    private logevent_endTakeImageTypeSupport typeSupport;

    public logevent_endTakeImageDataReaderViewImpl(camera.logevent_endTakeImageTypeSupport ts)
    {
        typeSupport = ts;
