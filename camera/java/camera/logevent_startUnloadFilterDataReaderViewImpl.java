...
public class logevent_startUnloadFilterDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_startUnloadFilterDataReaderView
{
    private long copyCache;
    private logevent_startUnloadFilterTypeSupport typeSupport;

    public logevent_startUnloadFilterDataReaderViewImpl(camera.logevent_startUnloadFilterTypeSupport ts)
    {
        typeSupport = ts;
