...
public class GASDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements GASDataReaderView
{
    private long copyCache;
    private GASTypeSupport typeSupport;

    public GASDataReaderViewImpl(camera.GASTypeSupport ts)
    {
        typeSupport = ts;
