...
public class logevent_SettingVersionsDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_SettingVersionsDataReaderView
{
    ...
    public logevent_SettingVersionsDataReaderViewImpl(camera.logevent_SettingVersionsTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.logevent_SettingVersionsSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.logevent_SettingVersionsHolder received_data,
    ...
    synchronized public int get_key_value(
            camera.logevent_SettingVersionsHolder key_holder,
            long handle)
    {
        long uView = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
	...
	camera.logevent_SettingVersions instance)
    {
        long uView = 0;
