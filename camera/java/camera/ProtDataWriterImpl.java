...
public class ProtDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements ProtDataWriter
{
    private long copyCache;
    private ProtTypeSupport typeSupport;

    public ProtDataWriterImpl(camera.ProtTypeSupport ts)
    {
        typeSupport = ts;
