...
public class FilterDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements FilterDataReader
{
    private long copyCache;
    private FilterTypeSupport typeSupport;

    public FilterDataReaderImpl(camera.FilterTypeSupport ts)
    {
        typeSupport = ts;
    ...
    */
    ...
    {
        return new FilterDataReaderViewImpl(typeSupport);
    }
}
