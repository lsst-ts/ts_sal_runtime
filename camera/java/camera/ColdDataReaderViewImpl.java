...
public class ColdDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements ColdDataReaderView
{
    private long copyCache;
    private ColdTypeSupport typeSupport;

    public ColdDataReaderViewImpl(camera.ColdTypeSupport ts)
    {
        typeSupport = ts;
