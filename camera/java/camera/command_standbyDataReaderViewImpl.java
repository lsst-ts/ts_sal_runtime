...
public class command_standbyDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements command_standbyDataReaderView
{
    ...
    public command_standbyDataReaderViewImpl(camera.command_standbyTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.command_standbySeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.command_standbyHolder received_data,
    ...
    synchronized public int get_key_value(
            camera.command_standbyHolder key_holder,
            long handle)
    {
        long uView = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
	...
	camera.command_standby instance)
    {
        long uView = 0;
