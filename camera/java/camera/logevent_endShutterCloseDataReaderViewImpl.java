...
public class logevent_endShutterCloseDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_endShutterCloseDataReaderView
{
    private long copyCache;
    private logevent_endShutterCloseTypeSupport typeSupport;

    public logevent_endShutterCloseDataReaderViewImpl(camera.logevent_endShutterCloseTypeSupport ts)
    {
        typeSupport = ts;
