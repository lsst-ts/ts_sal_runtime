...
public class logevent_endTakeImageDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements logevent_endTakeImageDataWriter
{
    private long copyCache;
    private logevent_endTakeImageTypeSupport typeSupport;

    public logevent_endTakeImageDataWriterImpl(camera.logevent_endTakeImageTypeSupport ts)
    {
        typeSupport = ts;
