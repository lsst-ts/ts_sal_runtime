...
public class logevent_endShutterOpenDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_endShutterOpenDataReaderView
{
    private long copyCache;
    private logevent_endShutterOpenTypeSupport typeSupport;

    public logevent_endShutterOpenDataReaderViewImpl(camera.logevent_endShutterOpenTypeSupport ts)
    {
        typeSupport = ts;
