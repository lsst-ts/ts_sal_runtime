...
public class logevent_endInitializeGuiderDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_endInitializeGuiderDataReaderView
{
    private long copyCache;
    private logevent_endInitializeGuiderTypeSupport typeSupport;

    public logevent_endInitializeGuiderDataReaderViewImpl(camera.logevent_endInitializeGuiderTypeSupport ts)
    {
        typeSupport = ts;
