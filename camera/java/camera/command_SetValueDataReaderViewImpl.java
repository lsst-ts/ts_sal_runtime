...
public class command_SetValueDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements command_SetValueDataReaderView
{
    ...
    public command_SetValueDataReaderViewImpl(camera.command_SetValueTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.command_SetValueSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.command_SetValueHolder received_data,
    ...
    synchronized public int get_key_value(
            camera.command_SetValueHolder key_holder,
            long handle)
    {
        long uView = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
	...
	camera.command_SetValue instance)
    {
        long uView = 0;
