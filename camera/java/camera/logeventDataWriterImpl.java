...
public class logeventDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements logeventDataWriter
{
    private long copyCache;
    private logeventTypeSupport typeSupport;

    public logeventDataWriterImpl(camera.logeventTypeSupport ts)
    {
        typeSupport = ts;
