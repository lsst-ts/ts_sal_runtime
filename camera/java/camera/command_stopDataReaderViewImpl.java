...
public class command_stopDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements command_stopDataReaderView
{
    private long copyCache;
    private command_stopTypeSupport typeSupport;

    public command_stopDataReaderViewImpl(camera.command_stopTypeSupport ts)
    {
        typeSupport = ts;
