...
public class logevent_startUnloadFilterDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements logevent_startUnloadFilterDataWriter
{
    private long copyCache;
    private logevent_startUnloadFilterTypeSupport typeSupport;

    public logevent_startUnloadFilterDataWriterImpl(camera.logevent_startUnloadFilterTypeSupport ts)
    {
        typeSupport = ts;
