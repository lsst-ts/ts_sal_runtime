...
public class CryoDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements CryoDataReader
{
    private long copyCache;
    private CryoTypeSupport typeSupport;

    public CryoDataReaderImpl(camera.CryoTypeSupport ts)
    {
        typeSupport = ts;
    ...
    */
    ...
    {
        return new CryoDataReaderViewImpl(typeSupport);
    }
}
