...
public class logevent_startLoadFilterDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_startLoadFilterDataReader
{
    private long copyCache;
    private logevent_startLoadFilterTypeSupport typeSupport;

    public logevent_startLoadFilterDataReaderImpl(camera.logevent_startLoadFilterTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.logevent_startLoadFilterSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.logevent_startLoadFilterHolder received_data,
    ...
    */
    ...
    synchronized public long lookup_instance(
        camera.logevent_startLoadFilter instance)
    {
        long uReader = 0;
    ...
    {
        return new logevent_startLoadFilterDataReaderViewImpl(typeSupport);
    }
}
