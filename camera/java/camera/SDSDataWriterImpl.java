...
public class SDSDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements SDSDataWriter
{
    private long copyCache;
    private SDSTypeSupport typeSupport;

    public SDSDataWriterImpl(camera.SDSTypeSupport ts)
    {
        typeSupport = ts;
