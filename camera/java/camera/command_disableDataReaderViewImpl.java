...
public class command_disableDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements command_disableDataReaderView
{
    ...
    public command_disableDataReaderViewImpl(camera.command_disableTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.command_disableSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.command_disableHolder received_data,
    ...
    synchronized public int get_key_value(
            camera.command_disableHolder key_holder,
            long handle)
    {
        long uView = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
	...
	camera.command_disable instance)
    {
        long uView = 0;
