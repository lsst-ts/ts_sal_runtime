...
public class command_startDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements command_startDataReaderView
{
    ...
    public command_startDataReaderViewImpl(camera.command_startTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.command_startSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.command_startHolder received_data,
    ...
    synchronized public int get_key_value(
            camera.command_startHolder key_holder,
            long handle)
    {
        long uView = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
