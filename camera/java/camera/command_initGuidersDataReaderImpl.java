...
public class command_initGuidersDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements command_initGuidersDataReader
{
    private long copyCache;
    private command_initGuidersTypeSupport typeSupport;

    public command_initGuidersDataReaderImpl(camera.command_initGuidersTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.command_initGuidersSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.command_initGuidersHolder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            camera.command_initGuidersHolder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    synchronized public long lookup_instance(
        camera.command_initGuiders instance)
    {
        long uReader = 0;
    ...
    {
        return new command_initGuidersDataReaderViewImpl(typeSupport);
    }
}
