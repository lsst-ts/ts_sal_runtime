...
public class CryoDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements CryoDataReaderView
{
    private long copyCache;
    private CryoTypeSupport typeSupport;

    public CryoDataReaderViewImpl(camera.CryoTypeSupport ts)
    {
        typeSupport = ts;
