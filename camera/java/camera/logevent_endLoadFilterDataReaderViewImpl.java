...
public class logevent_endLoadFilterDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_endLoadFilterDataReaderView
{
    private long copyCache;
    private logevent_endLoadFilterTypeSupport typeSupport;

    public logevent_endLoadFilterDataReaderViewImpl(camera.logevent_endLoadFilterTypeSupport ts)
    {
        typeSupport = ts;
