...
public class logevent_AppliedSettingsMatchStartDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_AppliedSettingsMatchStartDataReaderView
{
    ...
    public logevent_AppliedSettingsMatchStartDataReaderViewImpl(camera.logevent_AppliedSettingsMatchStartTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.logevent_AppliedSettingsMatchStartSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.logevent_AppliedSettingsMatchStartHolder received_data,
    ...
    synchronized public int get_key_value(
            camera.logevent_AppliedSettingsMatchStartHolder key_holder,
            long handle)
    {
        long uView = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
	...
	camera.logevent_AppliedSettingsMatchStart instance)
    {
        long uView = 0;
