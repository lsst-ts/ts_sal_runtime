...
public class command_initImageDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements command_initImageDataReaderView
{
    private long copyCache;
    private command_initImageTypeSupport typeSupport;

    public command_initImageDataReaderViewImpl(camera.command_initImageTypeSupport ts)
    {
        typeSupport = ts;
