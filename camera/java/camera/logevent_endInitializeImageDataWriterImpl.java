...
public class logevent_endInitializeImageDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements logevent_endInitializeImageDataWriter
{
    private long copyCache;
    private logevent_endInitializeImageTypeSupport typeSupport;

    public logevent_endInitializeImageDataWriterImpl(camera.logevent_endInitializeImageTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public long register_instance(
            camera.logevent_endInitializeImage instance_data)
    {
        long uWriter = 0;
