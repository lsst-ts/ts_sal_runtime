...
public class logevent_startShutterOpenDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements logevent_startShutterOpenDataWriter
{
    private long copyCache;
    private logevent_startShutterOpenTypeSupport typeSupport;

    public logevent_startShutterOpenDataWriterImpl(camera.logevent_startShutterOpenTypeSupport ts)
    {
        typeSupport = ts;
