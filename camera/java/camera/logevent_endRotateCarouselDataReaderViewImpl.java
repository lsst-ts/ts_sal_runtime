...
public class logevent_endRotateCarouselDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_endRotateCarouselDataReaderView
{
    private long copyCache;
    private logevent_endRotateCarouselTypeSupport typeSupport;

    public logevent_endRotateCarouselDataReaderViewImpl(camera.logevent_endRotateCarouselTypeSupport ts)
    {
        typeSupport = ts;
