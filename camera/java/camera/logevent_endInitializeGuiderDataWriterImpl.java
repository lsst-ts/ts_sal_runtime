...
public class logevent_endInitializeGuiderDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements logevent_endInitializeGuiderDataWriter
{
    private long copyCache;
    private logevent_endInitializeGuiderTypeSupport typeSupport;

    public logevent_endInitializeGuiderDataWriterImpl(camera.logevent_endInitializeGuiderTypeSupport ts)
    {
        typeSupport = ts;
