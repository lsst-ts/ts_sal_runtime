...
public class ShutterDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements ShutterDataReaderView
{
    private long copyCache;
    private ShutterTypeSupport typeSupport;

    public ShutterDataReaderViewImpl(camera.ShutterTypeSupport ts)
    {
        typeSupport = ts;
