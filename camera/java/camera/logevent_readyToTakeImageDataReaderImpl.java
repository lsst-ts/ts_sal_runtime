...
public class logevent_readyToTakeImageDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_readyToTakeImageDataReader
{
    private long copyCache;
    private logevent_readyToTakeImageTypeSupport typeSupport;

    public logevent_readyToTakeImageDataReaderImpl(camera.logevent_readyToTakeImageTypeSupport ts)
    {
        typeSupport = ts;
    ...
    */
    ...
    {
        return new logevent_readyToTakeImageDataReaderViewImpl(typeSupport);
    }
}
