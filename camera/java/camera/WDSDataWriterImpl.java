...
public class WDSDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements WDSDataWriter
{
    private long copyCache;
    private WDSTypeSupport typeSupport;

    public WDSDataWriterImpl(camera.WDSTypeSupport ts)
    {
        typeSupport = ts;
