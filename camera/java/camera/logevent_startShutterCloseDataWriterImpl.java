...
public class logevent_startShutterCloseDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements logevent_startShutterCloseDataWriter
{
    private long copyCache;
    private logevent_startShutterCloseTypeSupport typeSupport;

    public logevent_startShutterCloseDataWriterImpl(camera.logevent_startShutterCloseTypeSupport ts)
    {
        typeSupport = ts;
