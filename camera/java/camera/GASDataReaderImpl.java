...
public class GASDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements GASDataReader
{
    private long copyCache;
    private GASTypeSupport typeSupport;

    public GASDataReaderImpl(camera.GASTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.GASSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.GASHolder received_data,
    ...
    */
    ...
    {
        return new GASDataReaderViewImpl(typeSupport);
    }
}
