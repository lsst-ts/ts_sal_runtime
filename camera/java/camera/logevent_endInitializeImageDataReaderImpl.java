...
public class logevent_endInitializeImageDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_endInitializeImageDataReader
{
    private long copyCache;
    private logevent_endInitializeImageTypeSupport typeSupport;

    public logevent_endInitializeImageDataReaderImpl(camera.logevent_endInitializeImageTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.logevent_endInitializeImageSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.logevent_endInitializeImageHolder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            camera.logevent_endInitializeImageHolder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    synchronized public long lookup_instance(
        camera.logevent_endInitializeImage instance)
    {
        long uReader = 0;
    ...
    {
        return new logevent_endInitializeImageDataReaderViewImpl(typeSupport);
    }
}
