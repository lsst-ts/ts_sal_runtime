...
public class logevent_endLoadFilterDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements logevent_endLoadFilterDataWriter
{
    private long copyCache;
    private logevent_endLoadFilterTypeSupport typeSupport;

    public logevent_endLoadFilterDataWriterImpl(camera.logevent_endLoadFilterTypeSupport ts)
    {
        typeSupport = ts;
