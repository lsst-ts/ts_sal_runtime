...
public class SDSDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements SDSDataReaderView
{
    private long copyCache;
    private SDSTypeSupport typeSupport;

    public SDSDataReaderViewImpl(camera.SDSTypeSupport ts)
    {
        typeSupport = ts;
