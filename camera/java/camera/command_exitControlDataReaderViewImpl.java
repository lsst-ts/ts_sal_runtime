...
public class command_exitControlDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements command_exitControlDataReaderView
{
    ...
    public command_exitControlDataReaderViewImpl(camera.command_exitControlTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.command_exitControlSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.command_exitControlHolder received_data,
    ...
    synchronized public int get_key_value(
            camera.command_exitControlHolder key_holder,
            long handle)
    {
        long uView = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
	...
	camera.command_exitControl instance)
    {
        long uView = 0;
