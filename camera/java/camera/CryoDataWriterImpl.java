...
public class CryoDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements CryoDataWriter
{
    private long copyCache;
    private CryoTypeSupport typeSupport;

    public CryoDataWriterImpl(camera.CryoTypeSupport ts)
    {
        typeSupport = ts;
