...
public class Cluster_EncoderDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements Cluster_EncoderDataReaderView
{
    private long copyCache;
    private Cluster_EncoderTypeSupport typeSupport;

    public Cluster_EncoderDataReaderViewImpl(camera.Cluster_EncoderTypeSupport ts)
    {
        typeSupport = ts;
