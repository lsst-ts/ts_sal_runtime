...
public class logevent_endReadoutDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements logevent_endReadoutDataWriter
{
    private long copyCache;
    private logevent_endReadoutTypeSupport typeSupport;

    public logevent_endReadoutDataWriterImpl(camera.logevent_endReadoutTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public long register_instance(
            camera.logevent_endReadout instance_data)
    {
        long uWriter = 0;
