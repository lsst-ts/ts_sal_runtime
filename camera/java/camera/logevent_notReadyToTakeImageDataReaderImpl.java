...
public class logevent_notReadyToTakeImageDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_notReadyToTakeImageDataReader
{
    private long copyCache;
    private logevent_notReadyToTakeImageTypeSupport typeSupport;

    public logevent_notReadyToTakeImageDataReaderImpl(camera.logevent_notReadyToTakeImageTypeSupport ts)
    {
        typeSupport = ts;
    ...
    */
    ...
    {
        return new logevent_notReadyToTakeImageDataReaderViewImpl(typeSupport);
    }
}
