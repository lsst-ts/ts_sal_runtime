...
public class WASDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements WASDataReader
{
    private long copyCache;
    private WASTypeSupport typeSupport;

    public WASDataReaderImpl(camera.WASTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.WASSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.WASHolder received_data,
    ...
    */
    ...
    {
        return new WASDataReaderViewImpl(typeSupport);
    }
}
