...
public class Cluster_EncoderDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements Cluster_EncoderDataWriter
{
    private long copyCache;
    private Cluster_EncoderTypeSupport typeSupport;

    public Cluster_EncoderDataWriterImpl(camera.Cluster_EncoderTypeSupport ts)
    {
        typeSupport = ts;
