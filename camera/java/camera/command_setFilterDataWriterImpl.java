...
public class command_setFilterDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements command_setFilterDataWriter
{
    private long copyCache;
    private command_setFilterTypeSupport typeSupport;

    public command_setFilterDataWriterImpl(camera.command_setFilterTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public long register_instance(
            camera.command_setFilter instance_data)
    {
        long uWriter = 0;
