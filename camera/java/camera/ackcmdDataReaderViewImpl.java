...
public class ackcmdDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements ackcmdDataReaderView
{
    ...
    public ackcmdDataReaderViewImpl(camera.ackcmdTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.ackcmdSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.ackcmdHolder received_data,
