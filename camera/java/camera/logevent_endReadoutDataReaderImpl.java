...
public class logevent_endReadoutDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_endReadoutDataReader
{
    private long copyCache;
    private logevent_endReadoutTypeSupport typeSupport;

    public logevent_endReadoutDataReaderImpl(camera.logevent_endReadoutTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.logevent_endReadoutSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.logevent_endReadoutHolder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            camera.logevent_endReadoutHolder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    synchronized public long lookup_instance(
        camera.logevent_endReadout instance)
    {
        long uReader = 0;
    ...
    {
        return new logevent_endReadoutDataReaderViewImpl(typeSupport);
    }
}
