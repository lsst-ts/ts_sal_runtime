...
public class CCSDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements CCSDataReader
{
    private long copyCache;
    private CCSTypeSupport typeSupport;

    public CCSDataReaderImpl(camera.CCSTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.CCSSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.CCSHolder received_data,
    ...
    */
    ...
    {
        return new CCSDataReaderViewImpl(typeSupport);
    }
}
