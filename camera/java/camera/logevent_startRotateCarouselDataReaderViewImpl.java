...
public class logevent_startRotateCarouselDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_startRotateCarouselDataReaderView
{
    private long copyCache;
    private logevent_startRotateCarouselTypeSupport typeSupport;

    public logevent_startRotateCarouselDataReaderViewImpl(camera.logevent_startRotateCarouselTypeSupport ts)
    {
        typeSupport = ts;
