...
public class GDSDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements GDSDataReaderView
{
    private long copyCache;
    private GDSTypeSupport typeSupport;

    public GDSDataReaderViewImpl(camera.GDSTypeSupport ts)
    {
        typeSupport = ts;
