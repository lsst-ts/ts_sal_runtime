...
public class logevent_startShutterOpenDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_startShutterOpenDataReader
{
    private long copyCache;
    private logevent_startShutterOpenTypeSupport typeSupport;

    public logevent_startShutterOpenDataReaderImpl(camera.logevent_startShutterOpenTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.logevent_startShutterOpenSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.logevent_startShutterOpenHolder received_data,
    ...
    */
    ...
    synchronized public long lookup_instance(
        camera.logevent_startShutterOpen instance)
    {
        long uReader = 0;
    ...
    {
        return new logevent_startShutterOpenDataReaderViewImpl(typeSupport);
    }
}
