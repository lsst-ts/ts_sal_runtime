...
public class logevent_startIntegrationDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_startIntegrationDataReader
{
    private long copyCache;
    private logevent_startIntegrationTypeSupport typeSupport;

    public logevent_startIntegrationDataReaderImpl(camera.logevent_startIntegrationTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.logevent_startIntegrationSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.logevent_startIntegrationHolder received_data,
    ...
    */
    ...
    synchronized public long lookup_instance(
        camera.logevent_startIntegration instance)
    {
        long uReader = 0;
    ...
    {
        return new logevent_startIntegrationDataReaderViewImpl(typeSupport);
    }
}
