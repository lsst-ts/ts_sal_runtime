...
public class logevent_startShutterOpenDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_startShutterOpenDataReaderView
{
    private long copyCache;
    private logevent_startShutterOpenTypeSupport typeSupport;

    public logevent_startShutterOpenDataReaderViewImpl(camera.logevent_startShutterOpenTypeSupport ts)
    {
        typeSupport = ts;
