...
public class ColdDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements ColdDataWriter
{
    private long copyCache;
    private ColdTypeSupport typeSupport;

    public ColdDataWriterImpl(camera.ColdTypeSupport ts)
    {
        typeSupport = ts;
