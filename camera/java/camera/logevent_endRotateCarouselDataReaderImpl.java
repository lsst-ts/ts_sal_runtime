...
public class logevent_endRotateCarouselDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_endRotateCarouselDataReader
{
    private long copyCache;
    private logevent_endRotateCarouselTypeSupport typeSupport;

    public logevent_endRotateCarouselDataReaderImpl(camera.logevent_endRotateCarouselTypeSupport ts)
    {
        typeSupport = ts;
    ...
    */
    ...
    {
        return new logevent_endRotateCarouselDataReaderViewImpl(typeSupport);
    }
}
