...
public class SASDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements SASDataReaderView
{
    private long copyCache;
    private SASTypeSupport typeSupport;

    public SASDataReaderViewImpl(camera.SASTypeSupport ts)
    {
        typeSupport = ts;
