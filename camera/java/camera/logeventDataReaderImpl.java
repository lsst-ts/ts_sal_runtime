...
public class logeventDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logeventDataReader
{
    private long copyCache;
    private logeventTypeSupport typeSupport;

    public logeventDataReaderImpl(camera.logeventTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.logeventSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.logeventHolder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            camera.logeventHolder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    {
        return new logeventDataReaderViewImpl(typeSupport);
    }
}
