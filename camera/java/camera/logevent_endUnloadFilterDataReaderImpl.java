...
public class logevent_endUnloadFilterDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_endUnloadFilterDataReader
{
    private long copyCache;
    private logevent_endUnloadFilterTypeSupport typeSupport;

    public logevent_endUnloadFilterDataReaderImpl(camera.logevent_endUnloadFilterTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.logevent_endUnloadFilterSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.logevent_endUnloadFilterHolder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            camera.logevent_endUnloadFilterHolder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    synchronized public long lookup_instance(
        camera.logevent_endUnloadFilter instance)
    {
        long uReader = 0;
    ...
    {
        return new logevent_endUnloadFilterDataReaderViewImpl(typeSupport);
    }
}
