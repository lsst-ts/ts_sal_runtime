...
public class PCMSDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements PCMSDataWriter
{
    private long copyCache;
    private PCMSTypeSupport typeSupport;

    public PCMSDataWriterImpl(camera.PCMSTypeSupport ts)
    {
        typeSupport = ts;
