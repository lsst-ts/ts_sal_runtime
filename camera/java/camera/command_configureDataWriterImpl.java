...
public class command_configureDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements command_configureDataWriter
{
    private long copyCache;
    private command_configureTypeSupport typeSupport;

    public command_configureDataWriterImpl(camera.command_configureTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public long register_instance(
            camera.command_configure instance_data)
    {
        long uWriter = 0;
