...
public class logeventDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logeventDataReaderView
{
    private long copyCache;
    private logeventTypeSupport typeSupport;

    public logeventDataReaderViewImpl(camera.logeventTypeSupport ts)
    {
        typeSupport = ts;
