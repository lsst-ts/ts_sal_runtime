...
public class logevent_startLoadFilterDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_startLoadFilterDataReaderView
{
    private long copyCache;
    private logevent_startLoadFilterTypeSupport typeSupport;

    public logevent_startLoadFilterDataReaderViewImpl(camera.logevent_startLoadFilterTypeSupport ts)
    {
        typeSupport = ts;
