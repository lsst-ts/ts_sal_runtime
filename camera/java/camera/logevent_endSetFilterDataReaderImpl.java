...
public class logevent_endSetFilterDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_endSetFilterDataReader
{
    private long copyCache;
    private logevent_endSetFilterTypeSupport typeSupport;

    public logevent_endSetFilterDataReaderImpl(camera.logevent_endSetFilterTypeSupport ts)
    {
        typeSupport = ts;
    ...
    */
    ...
    {
        return new logevent_endSetFilterDataReaderViewImpl(typeSupport);
    }
}
