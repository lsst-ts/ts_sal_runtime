...
public class CCSDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements CCSDataWriter
{
    private long copyCache;
    private CCSTypeSupport typeSupport;

    public CCSDataWriterImpl(camera.CCSTypeSupport ts)
    {
        typeSupport = ts;
