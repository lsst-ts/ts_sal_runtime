...
public class logevent_endLoadFilterDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_endLoadFilterDataReader
{
    private long copyCache;
    private logevent_endLoadFilterTypeSupport typeSupport;

    public logevent_endLoadFilterDataReaderImpl(camera.logevent_endLoadFilterTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.logevent_endLoadFilterSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.logevent_endLoadFilterHolder received_data,
    ...
    */
    ...
    synchronized public long lookup_instance(
        camera.logevent_endLoadFilter instance)
    {
        long uReader = 0;
    ...
    {
        return new logevent_endLoadFilterDataReaderViewImpl(typeSupport);
    }
}
