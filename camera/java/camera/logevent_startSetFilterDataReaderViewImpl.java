...
public class logevent_startSetFilterDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_startSetFilterDataReaderView
{
    private long copyCache;
    private logevent_startSetFilterTypeSupport typeSupport;

    public logevent_startSetFilterDataReaderViewImpl(camera.logevent_startSetFilterTypeSupport ts)
    {
        typeSupport = ts;
