...
public class logevent_readyToTakeImageDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_readyToTakeImageDataReaderView
{
    private long copyCache;
    private logevent_readyToTakeImageTypeSupport typeSupport;

    public logevent_readyToTakeImageDataReaderViewImpl(camera.logevent_readyToTakeImageTypeSupport ts)
    {
        typeSupport = ts;
