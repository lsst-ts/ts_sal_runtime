...
public class logevent_AppliedSettingsMatchStartDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements logevent_AppliedSettingsMatchStartDataWriter
{
    ...
    public logevent_AppliedSettingsMatchStartDataWriterImpl(camera.logevent_AppliedSettingsMatchStartTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public long register_instance(
            camera.logevent_AppliedSettingsMatchStart instance_data)
    {
        long uWriter = 0;
