...
public class command_initImageDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements command_initImageDataReader
{
    private long copyCache;
    private command_initImageTypeSupport typeSupport;

    public command_initImageDataReaderImpl(camera.command_initImageTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.command_initImageSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.command_initImageHolder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            camera.command_initImageHolder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    synchronized public long lookup_instance(
        camera.command_initImage instance)
    {
        long uReader = 0;
    ...
    {
        return new command_initImageDataReaderViewImpl(typeSupport);
    }
}
