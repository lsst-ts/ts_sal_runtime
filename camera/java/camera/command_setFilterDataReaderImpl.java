...
public class command_setFilterDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements command_setFilterDataReader
{
    private long copyCache;
    private command_setFilterTypeSupport typeSupport;

    public command_setFilterDataReaderImpl(camera.command_setFilterTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.command_setFilterSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.command_setFilterHolder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            camera.command_setFilterHolder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    synchronized public long lookup_instance(
        camera.command_setFilter instance)
    {
        long uReader = 0;
    ...
    {
        return new command_setFilterDataReaderViewImpl(typeSupport);
    }
}
