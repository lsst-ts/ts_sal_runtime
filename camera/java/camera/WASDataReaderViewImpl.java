...
public class WASDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements WASDataReaderView
{
    private long copyCache;
    private WASTypeSupport typeSupport;

    public WASDataReaderViewImpl(camera.WASTypeSupport ts)
    {
        typeSupport = ts;
