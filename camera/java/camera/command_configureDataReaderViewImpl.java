...
public class command_configureDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements command_configureDataReaderView
{
    private long copyCache;
    private command_configureTypeSupport typeSupport;

    public command_configureDataReaderViewImpl(camera.command_configureTypeSupport ts)
    {
        typeSupport = ts;
