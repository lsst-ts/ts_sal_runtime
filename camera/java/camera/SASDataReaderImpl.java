...
public class SASDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements SASDataReader
{
    private long copyCache;
    private SASTypeSupport typeSupport;

    public SASDataReaderImpl(camera.SASTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.SASSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.SASHolder received_data,
    ...
    */
    ...
    {
        return new SASDataReaderViewImpl(typeSupport);
    }
}
