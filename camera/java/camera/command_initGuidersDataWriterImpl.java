...
public class command_initGuidersDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements command_initGuidersDataWriter
{
    private long copyCache;
    private command_initGuidersTypeSupport typeSupport;

    public command_initGuidersDataWriterImpl(camera.command_initGuidersTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public long register_instance(
            camera.command_initGuiders instance_data)
    {
        long uWriter = 0;
