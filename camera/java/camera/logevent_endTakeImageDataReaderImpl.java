...
public class logevent_endTakeImageDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_endTakeImageDataReader
{
    private long copyCache;
    private logevent_endTakeImageTypeSupport typeSupport;

    public logevent_endTakeImageDataReaderImpl(camera.logevent_endTakeImageTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.logevent_endTakeImageSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.logevent_endTakeImageHolder received_data,
    ...
    */
    ...
    synchronized public long lookup_instance(
        camera.logevent_endTakeImage instance)
    {
        long uReader = 0;
    ...
    {
        return new logevent_endTakeImageDataReaderViewImpl(typeSupport);
    }
}
