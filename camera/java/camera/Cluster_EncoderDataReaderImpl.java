...
public class Cluster_EncoderDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements Cluster_EncoderDataReader
{
    private long copyCache;
    private Cluster_EncoderTypeSupport typeSupport;

    public Cluster_EncoderDataReaderImpl(camera.Cluster_EncoderTypeSupport ts)
    {
        typeSupport = ts;
    ...
    */
    ...
    {
        return new Cluster_EncoderDataReaderViewImpl(typeSupport);
    }
}
