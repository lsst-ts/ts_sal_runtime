...
public class SASDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements SASDataWriter
{
    private long copyCache;
    private SASTypeSupport typeSupport;

    public SASDataWriterImpl(camera.SASTypeSupport ts)
    {
        typeSupport = ts;
