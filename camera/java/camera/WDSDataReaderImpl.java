...
public class WDSDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements WDSDataReader
{
    private long copyCache;
    private WDSTypeSupport typeSupport;

    public WDSDataReaderImpl(camera.WDSTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.WDSSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.WDSHolder received_data,
    ...
    */
    ...
    {
        return new WDSDataReaderViewImpl(typeSupport);
    }
}
