...
public class logevent_endInitializeImageDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_endInitializeImageDataReaderView
{
    private long copyCache;
    private logevent_endInitializeImageTypeSupport typeSupport;

    public logevent_endInitializeImageDataReaderViewImpl(camera.logevent_endInitializeImageTypeSupport ts)
    {
        typeSupport = ts;
