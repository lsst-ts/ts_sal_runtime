...
public class PurgeDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements PurgeDataReaderView
{
    private long copyCache;
    private PurgeTypeSupport typeSupport;

    public PurgeDataReaderViewImpl(camera.PurgeTypeSupport ts)
    {
        typeSupport = ts;
