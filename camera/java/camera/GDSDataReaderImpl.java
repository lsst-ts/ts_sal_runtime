...
public class GDSDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements GDSDataReader
{
    private long copyCache;
    private GDSTypeSupport typeSupport;

    public GDSDataReaderImpl(camera.GDSTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.GDSSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.GDSHolder received_data,
    ...
    */
    ...
    {
        return new GDSDataReaderViewImpl(typeSupport);
    }
}
