...
public class command_enterControlDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements command_enterControlDataReaderView
{
    ...
    public command_enterControlDataReaderViewImpl(camera.command_enterControlTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.command_enterControlSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.command_enterControlHolder received_data,
    ...
    synchronized public int get_key_value(
            camera.command_enterControlHolder key_holder,
            long handle)
    {
        long uView = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
	...
	camera.command_enterControl instance)
    {
        long uView = 0;
