...
public class FilterDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements FilterDataReaderView
{
    private long copyCache;
    private FilterTypeSupport typeSupport;

    public FilterDataReaderViewImpl(camera.FilterTypeSupport ts)
    {
        typeSupport = ts;
