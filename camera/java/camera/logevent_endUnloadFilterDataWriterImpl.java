...
public class logevent_endUnloadFilterDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements logevent_endUnloadFilterDataWriter
{
    private long copyCache;
    private logevent_endUnloadFilterTypeSupport typeSupport;

    public logevent_endUnloadFilterDataWriterImpl(camera.logevent_endUnloadFilterTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public long register_instance(
            camera.logevent_endUnloadFilter instance_data)
    {
        long uWriter = 0;
