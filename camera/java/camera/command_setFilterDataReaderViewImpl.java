...
public class command_setFilterDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements command_setFilterDataReaderView
{
    private long copyCache;
    private command_setFilterTypeSupport typeSupport;

    public command_setFilterDataReaderViewImpl(camera.command_setFilterTypeSupport ts)
    {
        typeSupport = ts;
