...
public class command_abortDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements command_abortDataReaderView
{
    ...
    public command_abortDataReaderViewImpl(camera.command_abortTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.command_abortSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.command_abortHolder received_data,
