...
public class GDSDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements GDSDataWriter
{
    private long copyCache;
    private GDSTypeSupport typeSupport;

    public GDSDataWriterImpl(camera.GDSTypeSupport ts)
    {
        typeSupport = ts;
