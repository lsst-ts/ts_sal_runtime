...
public class logevent_startReadoutDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_startReadoutDataReader
{
    private long copyCache;
    private logevent_startReadoutTypeSupport typeSupport;

    public logevent_startReadoutDataReaderImpl(camera.logevent_startReadoutTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.logevent_startReadoutSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.logevent_startReadoutHolder received_data,
    ...
    */
    ...
    synchronized public long lookup_instance(
        camera.logevent_startReadout instance)
    {
        long uReader = 0;
    ...
    {
        return new logevent_startReadoutDataReaderViewImpl(typeSupport);
    }
}
