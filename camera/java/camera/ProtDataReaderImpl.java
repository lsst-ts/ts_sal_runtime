...
public class ProtDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements ProtDataReader
{
    private long copyCache;
    private ProtTypeSupport typeSupport;

    public ProtDataReaderImpl(camera.ProtTypeSupport ts)
    {
        typeSupport = ts;
    ...
    */
    ...
    {
        return new ProtDataReaderViewImpl(typeSupport);
    }
}
