...
public class WDSDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements WDSDataReaderView
{
    private long copyCache;
    private WDSTypeSupport typeSupport;

    public WDSDataReaderViewImpl(camera.WDSTypeSupport ts)
    {
        typeSupport = ts;
