...
public class logevent_startRotateCarouselDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements logevent_startRotateCarouselDataWriter
{
    private long copyCache;
    private logevent_startRotateCarouselTypeSupport typeSupport;

    public logevent_startRotateCarouselDataWriterImpl(camera.logevent_startRotateCarouselTypeSupport ts)
    {
        typeSupport = ts;
