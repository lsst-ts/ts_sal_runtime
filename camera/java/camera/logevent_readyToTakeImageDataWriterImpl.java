...
public class logevent_readyToTakeImageDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements logevent_readyToTakeImageDataWriter
{
    private long copyCache;
    private logevent_readyToTakeImageTypeSupport typeSupport;

    public logevent_readyToTakeImageDataWriterImpl(camera.logevent_readyToTakeImageTypeSupport ts)
    {
        typeSupport = ts;
