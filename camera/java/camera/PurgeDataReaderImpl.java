...
public class PurgeDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements PurgeDataReader
{
    private long copyCache;
    private PurgeTypeSupport typeSupport;

    public PurgeDataReaderImpl(camera.PurgeTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.PurgeSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.PurgeHolder received_data,
    ...
    */
    ...
    {
        return new PurgeDataReaderViewImpl(typeSupport);
    }
}
