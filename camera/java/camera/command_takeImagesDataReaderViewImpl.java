...
public class command_takeImagesDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements command_takeImagesDataReaderView
{
    private long copyCache;
    private command_takeImagesTypeSupport typeSupport;

    public command_takeImagesDataReaderViewImpl(camera.command_takeImagesTypeSupport ts)
    {
        typeSupport = ts;
