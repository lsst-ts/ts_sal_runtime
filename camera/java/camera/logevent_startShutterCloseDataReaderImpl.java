...
public class logevent_startShutterCloseDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_startShutterCloseDataReader
{
    private long copyCache;
    private logevent_startShutterCloseTypeSupport typeSupport;

    public logevent_startShutterCloseDataReaderImpl(camera.logevent_startShutterCloseTypeSupport ts)
    {
        typeSupport = ts;
    ...
    */
    ...
    {
        return new logevent_startShutterCloseDataReaderViewImpl(typeSupport);
    }
}
