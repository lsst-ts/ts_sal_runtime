...
public class logevent_ccsConfiguredDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_ccsConfiguredDataReaderView
{
    private long copyCache;
    private logevent_ccsConfiguredTypeSupport typeSupport;

    public logevent_ccsConfiguredDataReaderViewImpl(camera.logevent_ccsConfiguredTypeSupport ts)
    {
        typeSupport = ts;
