...
public class command_configureDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements command_configureDataReader
{
    private long copyCache;
    private command_configureTypeSupport typeSupport;

    public command_configureDataReaderImpl(camera.command_configureTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.command_configureSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.command_configureHolder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            camera.command_configureHolder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    synchronized public long lookup_instance(
        camera.command_configure instance)
    {
        long uReader = 0;
    ...
    {
        return new command_configureDataReaderViewImpl(typeSupport);
    }
}
