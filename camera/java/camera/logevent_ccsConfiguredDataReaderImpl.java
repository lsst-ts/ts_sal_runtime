...
public class logevent_ccsConfiguredDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_ccsConfiguredDataReader
{
    private long copyCache;
    private logevent_ccsConfiguredTypeSupport typeSupport;

    public logevent_ccsConfiguredDataReaderImpl(camera.logevent_ccsConfiguredTypeSupport ts)
    {
        typeSupport = ts;
    ...
    */
    ...
    {
        return new logevent_ccsConfiguredDataReaderViewImpl(typeSupport);
    }
}
