...
public class logevent_endSetFilterDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_endSetFilterDataReaderView
{
    private long copyCache;
    private logevent_endSetFilterTypeSupport typeSupport;

    public logevent_endSetFilterDataReaderViewImpl(camera.logevent_endSetFilterTypeSupport ts)
    {
        typeSupport = ts;
