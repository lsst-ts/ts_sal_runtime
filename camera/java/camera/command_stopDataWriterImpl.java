...
public class command_stopDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements command_stopDataWriter
{
    private long copyCache;
    private command_stopTypeSupport typeSupport;

    public command_stopDataWriterImpl(camera.command_stopTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public long register_instance(
            camera.command_stop instance_data)
    {
        long uWriter = 0;
