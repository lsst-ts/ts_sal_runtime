...
public class PCMSDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements PCMSDataReaderView
{
    private long copyCache;
    private PCMSTypeSupport typeSupport;

    public PCMSDataReaderViewImpl(camera.PCMSTypeSupport ts)
    {
        typeSupport = ts;
