...
public class logevent_startReadoutDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_startReadoutDataReaderView
{
    private long copyCache;
    private logevent_startReadoutTypeSupport typeSupport;

    public logevent_startReadoutDataReaderViewImpl(camera.logevent_startReadoutTypeSupport ts)
    {
        typeSupport = ts;
