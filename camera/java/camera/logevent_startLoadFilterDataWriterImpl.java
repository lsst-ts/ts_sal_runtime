...
public class logevent_startLoadFilterDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements logevent_startLoadFilterDataWriter
{
    private long copyCache;
    private logevent_startLoadFilterTypeSupport typeSupport;

    public logevent_startLoadFilterDataWriterImpl(camera.logevent_startLoadFilterTypeSupport ts)
    {
        typeSupport = ts;
