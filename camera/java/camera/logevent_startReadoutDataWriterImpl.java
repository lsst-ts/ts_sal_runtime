...
public class logevent_startReadoutDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements logevent_startReadoutDataWriter
{
    private long copyCache;
    private logevent_startReadoutTypeSupport typeSupport;

    public logevent_startReadoutDataWriterImpl(camera.logevent_startReadoutTypeSupport ts)
    {
        typeSupport = ts;
