...
public class logevent_endShutterCloseDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_endShutterCloseDataReader
{
    private long copyCache;
    private logevent_endShutterCloseTypeSupport typeSupport;

    public logevent_endShutterCloseDataReaderImpl(camera.logevent_endShutterCloseTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.logevent_endShutterCloseSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.logevent_endShutterCloseHolder received_data,
    ...
    */
    ...
    synchronized public long lookup_instance(
        camera.logevent_endShutterClose instance)
    {
        long uReader = 0;
    ...
    {
        return new logevent_endShutterCloseDataReaderViewImpl(typeSupport);
    }
}
