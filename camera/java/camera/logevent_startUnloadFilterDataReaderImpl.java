...
public class logevent_startUnloadFilterDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_startUnloadFilterDataReader
{
    private long copyCache;
    private logevent_startUnloadFilterTypeSupport typeSupport;

    public logevent_startUnloadFilterDataReaderImpl(camera.logevent_startUnloadFilterTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.logevent_startUnloadFilterSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.logevent_startUnloadFilterHolder received_data,
    ...
    */
    ...
    synchronized public long lookup_instance(
        camera.logevent_startUnloadFilter instance)
    {
        long uReader = 0;
    ...
    {
        return new logevent_startUnloadFilterDataReaderViewImpl(typeSupport);
    }
}
