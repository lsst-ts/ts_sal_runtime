...
public class logevent_endSetFilterDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements logevent_endSetFilterDataWriter
{
    private long copyCache;
    private logevent_endSetFilterTypeSupport typeSupport;

    public logevent_endSetFilterDataWriterImpl(camera.logevent_endSetFilterTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public long register_instance(
            camera.logevent_endSetFilter instance_data)
    {
        long uWriter = 0;
