...
public class ShutterDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements ShutterDataWriter
{
    private long copyCache;
    private ShutterTypeSupport typeSupport;

    public ShutterDataWriterImpl(camera.ShutterTypeSupport ts)
    {
        typeSupport = ts;
