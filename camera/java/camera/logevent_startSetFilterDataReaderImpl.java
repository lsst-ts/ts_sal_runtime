...
public class logevent_startSetFilterDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_startSetFilterDataReader
{
    private long copyCache;
    private logevent_startSetFilterTypeSupport typeSupport;

    public logevent_startSetFilterDataReaderImpl(camera.logevent_startSetFilterTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.logevent_startSetFilterSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.logevent_startSetFilterHolder received_data,
    ...
    */
    ...
    synchronized public long lookup_instance(
        camera.logevent_startSetFilter instance)
    {
        long uReader = 0;
    ...
    {
        return new logevent_startSetFilterDataReaderViewImpl(typeSupport);
    }
}
