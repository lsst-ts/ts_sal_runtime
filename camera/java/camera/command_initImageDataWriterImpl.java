...
public class command_initImageDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements command_initImageDataWriter
{
    private long copyCache;
    private command_initImageTypeSupport typeSupport;

    public command_initImageDataWriterImpl(camera.command_initImageTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public long register_instance(
            camera.command_initImage instance_data)
    {
        long uWriter = 0;
