...
public class logevent_ErrorCodeDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_ErrorCodeDataReaderView
{
    ...
    public logevent_ErrorCodeDataReaderViewImpl(camera.logevent_ErrorCodeTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.logevent_ErrorCodeSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.logevent_ErrorCodeHolder received_data,
    ...
    synchronized public int get_key_value(
            camera.logevent_ErrorCodeHolder key_holder,
            long handle)
    {
        long uView = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
	...
	camera.logevent_ErrorCode instance)
    {
        long uView = 0;
