...
public class logevent_endRotateCarouselDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements logevent_endRotateCarouselDataWriter
{
    private long copyCache;
    private logevent_endRotateCarouselTypeSupport typeSupport;

    public logevent_endRotateCarouselDataWriterImpl(camera.logevent_endRotateCarouselTypeSupport ts)
    {
        typeSupport = ts;
