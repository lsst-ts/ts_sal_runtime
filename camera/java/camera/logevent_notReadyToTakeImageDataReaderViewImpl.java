...
public class logevent_notReadyToTakeImageDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_notReadyToTakeImageDataReaderView
{
    private long copyCache;
    private logevent_notReadyToTakeImageTypeSupport typeSupport;

    public logevent_notReadyToTakeImageDataReaderViewImpl(camera.logevent_notReadyToTakeImageTypeSupport ts)
    {
        typeSupport = ts;
