...
public class logevent_startShutterCloseDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_startShutterCloseDataReaderView
{
    private long copyCache;
    private logevent_startShutterCloseTypeSupport typeSupport;

    public logevent_startShutterCloseDataReaderViewImpl(camera.logevent_startShutterCloseTypeSupport ts)
    {
        typeSupport = ts;
