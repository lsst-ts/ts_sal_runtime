...
public class CCSDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements CCSDataReaderView
{
    private long copyCache;
    private CCSTypeSupport typeSupport;

    public CCSDataReaderViewImpl(camera.CCSTypeSupport ts)
    {
        typeSupport = ts;
