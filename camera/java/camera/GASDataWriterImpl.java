...
public class GASDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements GASDataWriter
{
    private long copyCache;
    private GASTypeSupport typeSupport;

    public GASDataWriterImpl(camera.GASTypeSupport ts)
    {
        typeSupport = ts;
