...
public class logevent_startIntegrationDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_startIntegrationDataReaderView
{
    private long copyCache;
    private logevent_startIntegrationTypeSupport typeSupport;

    public logevent_startIntegrationDataReaderViewImpl(camera.logevent_startIntegrationTypeSupport ts)
    {
        typeSupport = ts;
