...
public class logevent_notReadyToTakeImageDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements logevent_notReadyToTakeImageDataWriter
{
    private long copyCache;
    private logevent_notReadyToTakeImageTypeSupport typeSupport;

    public logevent_notReadyToTakeImageDataWriterImpl(camera.logevent_notReadyToTakeImageTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public long register_instance(
            camera.logevent_notReadyToTakeImage instance_data)
    {
        long uWriter = 0;
