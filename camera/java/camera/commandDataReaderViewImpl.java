...
public class commandDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements commandDataReaderView
{
    private long copyCache;
    private commandTypeSupport typeSupport;

    public commandDataReaderViewImpl(camera.commandTypeSupport ts)
    {
        typeSupport = ts;
