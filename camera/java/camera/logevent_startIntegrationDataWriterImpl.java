...
public class logevent_startIntegrationDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements logevent_startIntegrationDataWriter
{
    private long copyCache;
    private logevent_startIntegrationTypeSupport typeSupport;

    public logevent_startIntegrationDataWriterImpl(camera.logevent_startIntegrationTypeSupport ts)
    {
        typeSupport = ts;
