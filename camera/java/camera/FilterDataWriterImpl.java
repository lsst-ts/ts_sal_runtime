...
public class FilterDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements FilterDataWriter
{
    private long copyCache;
    private FilterTypeSupport typeSupport;

    public FilterDataWriterImpl(camera.FilterTypeSupport ts)
    {
        typeSupport = ts;
