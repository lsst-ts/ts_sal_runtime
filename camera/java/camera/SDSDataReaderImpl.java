...
public class SDSDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements SDSDataReader
{
    private long copyCache;
    private SDSTypeSupport typeSupport;

    public SDSDataReaderImpl(camera.SDSTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.SDSSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.SDSHolder received_data,
    ...
    */
    ...
    {
        return new SDSDataReaderViewImpl(typeSupport);
    }
}
