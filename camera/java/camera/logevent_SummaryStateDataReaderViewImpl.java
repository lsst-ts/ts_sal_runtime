...
public class logevent_SummaryStateDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_SummaryStateDataReaderView
{
    ...
    public logevent_SummaryStateDataReaderViewImpl(camera.logevent_SummaryStateTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.logevent_SummaryStateSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.logevent_SummaryStateHolder received_data,
    ...
    synchronized public int get_key_value(
            camera.logevent_SummaryStateHolder key_holder,
            long handle)
    {
        long uView = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
	...
	camera.logevent_SummaryState instance)
    {
        long uView = 0;
