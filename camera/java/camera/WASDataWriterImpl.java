...
public class WASDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements WASDataWriter
{
    private long copyCache;
    private WASTypeSupport typeSupport;

    public WASDataWriterImpl(camera.WASTypeSupport ts)
    {
        typeSupport = ts;
