...
public class logevent_ccsConfiguredDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements logevent_ccsConfiguredDataWriter
{
    private long copyCache;
    private logevent_ccsConfiguredTypeSupport typeSupport;

    public logevent_ccsConfiguredDataWriterImpl(camera.logevent_ccsConfiguredTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public long register_instance(
            camera.logevent_ccsConfigured instance_data)
    {
        long uWriter = 0;
