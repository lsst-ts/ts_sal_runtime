...
public class commandDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements commandDataWriter
{
    private long copyCache;
    private commandTypeSupport typeSupport;

    public commandDataWriterImpl(camera.commandTypeSupport ts)
    {
        typeSupport = ts;
