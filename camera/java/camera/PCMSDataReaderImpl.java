...
public class PCMSDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements PCMSDataReader
{
    private long copyCache;
    private PCMSTypeSupport typeSupport;

    public PCMSDataReaderImpl(camera.PCMSTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.PCMSSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.PCMSHolder received_data,
    ...
    */
    ...
    {
        return new PCMSDataReaderViewImpl(typeSupport);
    }
}
