...
public class logevent_endUnloadFilterDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_endUnloadFilterDataReaderView
{
    private long copyCache;
    private logevent_endUnloadFilterTypeSupport typeSupport;

    public logevent_endUnloadFilterDataReaderViewImpl(camera.logevent_endUnloadFilterTypeSupport ts)
    {
        typeSupport = ts;
