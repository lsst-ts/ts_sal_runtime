...
public class ProtDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements ProtDataReaderView
{
    private long copyCache;
    private ProtTypeSupport typeSupport;

    public ProtDataReaderViewImpl(camera.ProtTypeSupport ts)
    {
        typeSupport = ts;
