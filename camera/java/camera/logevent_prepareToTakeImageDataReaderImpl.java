...
public class logevent_prepareToTakeImageDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_prepareToTakeImageDataReader
{
    private long copyCache;
    private logevent_prepareToTakeImageTypeSupport typeSupport;

    public logevent_prepareToTakeImageDataReaderImpl(camera.logevent_prepareToTakeImageTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.logevent_prepareToTakeImageSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.logevent_prepareToTakeImageHolder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            camera.logevent_prepareToTakeImageHolder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    synchronized public long lookup_instance(
        camera.logevent_prepareToTakeImage instance)
    {
        long uReader = 0;
    ...
    {
        return new logevent_prepareToTakeImageDataReaderViewImpl(typeSupport);
    }
}
