...
public class logevent_prepareToTakeImageDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_prepareToTakeImageDataReaderView
{
    private long copyCache;
    private logevent_prepareToTakeImageTypeSupport typeSupport;

    public logevent_prepareToTakeImageDataReaderViewImpl(camera.logevent_prepareToTakeImageTypeSupport ts)
    {
        typeSupport = ts;
