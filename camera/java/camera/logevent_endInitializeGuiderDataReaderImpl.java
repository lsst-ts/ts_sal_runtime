...
public class logevent_endInitializeGuiderDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_endInitializeGuiderDataReader
{
    private long copyCache;
    private logevent_endInitializeGuiderTypeSupport typeSupport;

    public logevent_endInitializeGuiderDataReaderImpl(camera.logevent_endInitializeGuiderTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.logevent_endInitializeGuiderSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.logevent_endInitializeGuiderHolder received_data,
    ...
    */
    ...
    synchronized public long lookup_instance(
        camera.logevent_endInitializeGuider instance)
    {
        long uReader = 0;
    ...
    {
        return new logevent_endInitializeGuiderDataReaderViewImpl(typeSupport);
    }
}
