...
public class logevent_endShutterOpenDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_endShutterOpenDataReader
{
    private long copyCache;
    private logevent_endShutterOpenTypeSupport typeSupport;

    public logevent_endShutterOpenDataReaderImpl(camera.logevent_endShutterOpenTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.logevent_endShutterOpenSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.logevent_endShutterOpenHolder received_data,
    ...
    */
    ...
    synchronized public long lookup_instance(
        camera.logevent_endShutterOpen instance)
    {
        long uReader = 0;
    ...
    {
        return new logevent_endShutterOpenDataReaderViewImpl(typeSupport);
    }
}
