...
public class PurgeDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements PurgeDataWriter
{
    private long copyCache;
    private PurgeTypeSupport typeSupport;

    public PurgeDataWriterImpl(camera.PurgeTypeSupport ts)
    {
        typeSupport = ts;
