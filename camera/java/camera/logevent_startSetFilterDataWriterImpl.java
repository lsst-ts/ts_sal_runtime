...
public class logevent_startSetFilterDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements logevent_startSetFilterDataWriter
{
    private long copyCache;
    private logevent_startSetFilterTypeSupport typeSupport;

    public logevent_startSetFilterDataWriterImpl(camera.logevent_startSetFilterTypeSupport ts)
    {
        typeSupport = ts;
