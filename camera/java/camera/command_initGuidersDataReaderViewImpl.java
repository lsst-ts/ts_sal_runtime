...
public class command_initGuidersDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements command_initGuidersDataReaderView
{
    private long copyCache;
    private command_initGuidersTypeSupport typeSupport;

    public command_initGuidersDataReaderViewImpl(camera.command_initGuidersTypeSupport ts)
    {
        typeSupport = ts;
