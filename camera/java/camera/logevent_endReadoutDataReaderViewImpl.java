...
public class logevent_endReadoutDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements logevent_endReadoutDataReaderView
{
    private long copyCache;
    private logevent_endReadoutTypeSupport typeSupport;

    public logevent_endReadoutDataReaderViewImpl(camera.logevent_endReadoutTypeSupport ts)
    {
        typeSupport = ts;
