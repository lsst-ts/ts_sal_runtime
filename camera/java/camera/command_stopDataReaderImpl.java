...
public class command_stopDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements command_stopDataReader
{
    private long copyCache;
    private command_stopTypeSupport typeSupport;

    public command_stopDataReaderImpl(camera.command_stopTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.command_stopSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.command_stopHolder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            camera.command_stopHolder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    {
        return new command_stopDataReaderViewImpl(typeSupport);
    }
}
