...
public class ColdDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements ColdDataReader
{
    private long copyCache;
    private ColdTypeSupport typeSupport;

    public ColdDataReaderImpl(camera.ColdTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            camera.ColdSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            camera.ColdHolder received_data,
    ...
    */
    ...
    {
        return new ColdDataReaderViewImpl(typeSupport);
    }
}
