...
public class cameraEventLogger_startReadoutTest {
	...
	public static void main(String[] args) {
	  ...
	  SAL_camera evt = new SAL_camera();
          evt.salEvent("camera_logevent_startReadout");
	  camera.logevent_startReadout event = new camera.logevent_startReadout();
          System.out.println("Event startReadout logger ready ");

	  while (!finished) {
	     status = evt.getEvent_startReadout(event);
