...
public class cameraEventLogger_endLoadFilterTest {
	...
	public static void main(String[] args) {
	  ...
	  SAL_camera evt = new SAL_camera();
          evt.salEvent("camera_logevent_endLoadFilter");
	  camera.logevent_endLoadFilter event = new camera.logevent_endLoadFilter();
          System.out.println("Event endLoadFilter logger ready ");

	  while (!finished) {
	     status = evt.getEvent_endLoadFilter(event);
