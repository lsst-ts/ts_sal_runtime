/* altTheme.c,v 1.62 2006/08/24 05:27:03 jenglish Exp
 *
...
static Ttk_ElementOptionSpec ArrowElementOptions[] =
{
	...
	Tk_Offset(ArrowElement,sizeObj), STR(SCROLLBAR_WIDTH) },
    { "-background", TK_OPTION_BORDER, 
...
static Ttk_ElementOptionSpec MenubuttonArrowElementOptions[] =
{
    ...
    { "-arrowsize", TK_OPTION_PIXELS,
	Tk_Offset(MenubuttonArrowElement,sizeObj), STR(MENUBUTTON_ARROW_SIZE)},
    { "-arrowcolor",TK_OPTION_COLOR,
...
int AltTheme_Init(Tcl_Interp *interp)
{
    ...
    Tcl_PkgProvide(interp, "tile::theme::alt", TILE_VERSION);
