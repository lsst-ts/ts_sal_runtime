/*
 * aquaTheme.c,v 1.34 2006/07/29 21:27:54 jenglish Exp
 *
 ...
 *	Tk/tile uses the term "active" to mean that the mouse cursor
...
int AquaTheme_Init(Tcl_Interp *interp)
{
    ...
    Tcl_PkgProvide(interp, "tile::theme::aqua", TILE_VERSION);
    return TCL_OK;
}
