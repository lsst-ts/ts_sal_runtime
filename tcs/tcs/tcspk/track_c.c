...
void tcsTrack_c ( double xtar, double ytar, double ztar,
                  double spm1[3][3],
...
**  at a specified place in the focal plane.  The target is specified in
**  Cartesian form.
**
...
**     rotap    double        predicted rotator mechanical angle (Note 5)
**     ap       double        predicted roll (Note 6)
**     bp       double        predicted pitch (Note 6)
...
**     yt       double        telescope vector, y-component (Note 7)
**     zt       double        telescope vector, z-component (Note 7)
**     ga       double        guiding correction, collimation
**     gb       double        guiding correction, pitch
**     rnogo    double        radius of "no go" region (radians, Note 8)
**
**  Returned:
**     xa       double        AIM x-coordinate (Note 1)
**     ya       double        AIM y-coordinate (Note 1)
**     za       double        AIM z-coordinate (Note 1)
**     enca1    double        roll coordinate, first solution (Note 9)
**     encb1    double        pitch coordinate, first solution (Note 9)
**     enca2    double        roll coordinate, second solution (Note 9)
**     encb2    double        pitch coordinate, second solution (Note 9)
**     j        int           status: +1 = pole avoidance (Note 10)
**                                     0 = OK
...
**
**  5  The predicted rotator angle rotap is the orientation that the
...
**
**  6  The arguments ap and bp are an estimate of the coordinates
**     a and b which are being computed.  The results are not very
**     sensitive to the values used.
**
**  7  The TELESCOPE vector [xt,yt,zt] is in this frame:
**
...
**
**  8  Near the pole of the mounting (i.e. the zenith in the case of an
...
**
**  9  If the mount is an altazimuth, the roll coordinate is pi-azimuth
...
**
**  10 Near the pole of the mounting, especially when the collimation
