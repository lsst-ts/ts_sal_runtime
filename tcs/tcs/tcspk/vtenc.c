...
void tcsVTenc ( double tara, double tarb,
                double spm1[3][3],
...
**  origin generate the mount encoder demands.
**
**  Given:
...
**
**  Returned:
**     enca1    double*       roll, first solution (Note 8)
**     encb1    double*       pitch, first solution (Note 8)
**     enca2    double*       roll, second solution (Note 8)
**     encb2    double*       pitch, second solution (Note 8)
...
**
**  4  The predicted rotator angle rotap is the expected position of
...
**
**  8  If the mount is an altazimuth, a is pi-azimuth and b is
...
**     (see Note 7).
**
**  10 This routine is optimized for speed, and accordingly no
