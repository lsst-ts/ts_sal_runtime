...
/// Virtual base class for demonstation pointing kernel applications
    class Pcs {
        ...
        friend int WrapCmd( ClientData clientdata,
                Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]);
//        friend int domeTrackCmd( ClientData clientdata,
//                Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]);
//        friend int domeCrawlCmd( ClientData clientdata,
//                Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]);
//        friend int cameraHexapodMoveCmd( ClientData clientdata,
//                Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]);
//        friend int m2HexapodMoveCmd( ClientData clientdata,
//                Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]);
        public:
...
//            SAL_dome*    salDOME;
//            SAL_hexapod* salCAMHEX;
//            SAL_hexapod* salM2HEX;
