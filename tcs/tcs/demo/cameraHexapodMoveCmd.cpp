...
/// Handler procedure for the tpk::cameraHexapodMoveCmd command

//    extern "C"
    int cameraHexapodMoveCmd( ClientData clientdata, Tcl_Interp *interp,
    ...
    status = hexapodCalculator(CAMERA_HEXAPOD,elevation,&newPosition);    
    ...
    int salcmd = static_cast<Pcs*>(clientdata)->salCAMHEX->issueCommand_move(&newPosition);
