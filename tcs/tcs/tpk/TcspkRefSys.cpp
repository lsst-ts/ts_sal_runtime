/// \file TcspkRefSys.cpp
/// \brief Implementation of the tcspk coordinate reference system class.
...
*/
    vector TcspkRefSys::ptrani(
        ...
        tcspk::tcsPtrani ( aim.x, aim.y, aim.z, tdbj, 
                ...
                hm, tlat, diurab, mFrame, 2000.0, refa, refb, temp, press, 
                humid, tlr, wavel, refsub, sst, cst, pos );
...
/// Update target transformation
    void TcspkRefSys::tartran(
        ...
        if ( tcspk::tcsTartr_c( ttj, const_cast<double*>(amprms),
                ...
                sst, cst, mFrame, 2000.0, tar.x, tar.y, tar.z,
...
*/
    int TcspkRefSys::track(
        ...
        double& ad1,                  ///< roll coordinate, first solution i
                                      ///  (radians)
        double& bd1,                  ///< pitch coordinate, first solution i
                                      ///  (radians)
        double& ad2,                  ///< roll coordinate, second solution i
                                      ///  (radians)
        double& bd2                   ///< pitch coordinate, second solution i
                                      ///  (radians)
    ) const throw () {
        int j;
